...
export const Index: Record<string, RegistryItem> = {
	...
	'echarts-chart': {
		...
		files: [{"path":"ui/echarts-chart/chart-container.svelte","type":"registry:component","target":"$lib/components/evilcharts/ui/echarts-chart/chart-container.svelte"},{"path":"ui/echarts-chart/chart-style.svelte","type":"registry:component","target":"$lib/components/evilcharts/ui/echarts-chart/chart-style.svelte"},{"path":"ui/echarts-chart/colors.ts","type":"registry:component","target":"$lib/components/evilcharts/ui/echarts-chart/colors.ts"},{"path":"ui/echarts-chart/echarts-host.svelte","type":"registry:component","target":"$lib/components/evilcharts/ui/echarts-chart/echarts-host.svelte"},{"path":"ui/echarts-chart/index.ts","type":"registry:component","target":"$lib/components/evilcharts/ui/echarts-chart/index.ts"},{"path":"ui/echarts-chart/loading-indicator.svelte","type":"registry:component","target":"$lib/components/evilcharts/ui/echarts-chart/loading-indicator.svelte"},{"path":"ui/echarts-chart/registrations.svelte.ts","type":"registry:component","target":"$lib/components/evilcharts/ui/echarts-chart/registrations.svelte.ts"},{"path":"ui/echarts-chart/shared-slots.svelte.ts","type":"registry:component","target":"$lib/components/evilcharts/ui/echarts-chart/shared-slots.svelte.ts"},{"path":"ui/echarts-chart/types.ts","type":"registry:component","target":"$lib/components/evilcharts/ui/echarts-chart/types.ts"}]
	},
	'echarts-dither': {
		name: 'echarts-dither',
	...
	'echarts-brush': {
		...
		registryDependencies: ["@evilcharts/evilcharts-notice","@evilcharts/echarts-chart"],
		dependencies: ["echarts@^6.1.0"],
		files: [{"path":"ui/echarts-brush/brush.svelte","type":"registry:component","target":"$lib/components/evilcharts/ui/echarts-brush/brush.svelte"},{"path":"ui/echarts-brush/brush.ts","type":"registry:component","target":"$lib/components/evilcharts/ui/echarts-brush/brush.ts"},{"path":"ui/echarts-brush/index.ts","type":"registry:component","target":"$lib/components/evilcharts/ui/echarts-brush/index.ts"}]
	},
