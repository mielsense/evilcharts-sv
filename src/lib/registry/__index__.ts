...
export const Index: Record<string, RegistryItem> = {
	'layerchart-chart': {
		...
		files: [{"path":"ui/layerchart-chart/bar-geometry.ts","type":"registry:component","target":"$lib/components/evilcharts/ui/layerchart-chart/bar-geometry.ts"},{"path":"ui/layerchart-chart/chart-config.ts","type":"registry:component","target":"$lib/components/evilcharts/ui/layerchart-chart/chart-config.ts"},{"path":"ui/layerchart-chart/chart-container.svelte","type":"registry:component","target":"$lib/components/evilcharts/ui/layerchart-chart/chart-container.svelte"},{"path":"ui/layerchart-chart/chart-context.svelte.ts","type":"registry:component","target":"$lib/components/evilcharts/ui/layerchart-chart/chart-context.svelte.ts"},{"path":"ui/layerchart-chart/chart-style.svelte","type":"registry:component","target":"$lib/components/evilcharts/ui/layerchart-chart/chart-style.svelte"},{"path":"ui/layerchart-chart/colors.ts","type":"registry:component","target":"$lib/components/evilcharts/ui/layerchart-chart/colors.ts"},{"path":"ui/layerchart-chart/curves.ts","type":"registry:component","target":"$lib/components/evilcharts/ui/layerchart-chart/curves.ts"},{"path":"ui/layerchart-chart/format.ts","type":"registry:component","target":"$lib/components/evilcharts/ui/layerchart-chart/format.ts"},{"path":"ui/layerchart-chart/index.ts","type":"registry:component","target":"$lib/components/evilcharts/ui/layerchart-chart/index.ts"},{"path":"ui/layerchart-chart/loading-indicator.svelte","type":"registry:component","target":"$lib/components/evilcharts/ui/layerchart-chart/loading-indicator.svelte"},{"path":"ui/layerchart-chart/loading.ts","type":"registry:component","target":"$lib/components/evilcharts/ui/layerchart-chart/loading.ts"},{"path":"ui/layerchart-chart/payload.ts","type":"registry:component","target":"$lib/components/evilcharts/ui/layerchart-chart/payload.ts"},{"path":"ui/layerchart-chart/ticks.ts","type":"registry:component","target":"$lib/components/evilcharts/ui/layerchart-chart/ticks.ts"}]
	},
	'layerchart-tooltip': {
	...
	'layerchart-area-chart': {
		...
		type: 'registry:component',
		registryDependencies: ["@evilcharts/layerchart-chart","@evilcharts/layerchart-tooltip","@evilcharts/layerchart-legend","@evilcharts/layerchart-dot","@evilcharts/layerchart-brush","@evilcharts/layerchart-background"],
	...
	'layerchart-bar-chart': {
		...
		type: 'registry:component',
		registryDependencies: ["@evilcharts/layerchart-chart","@evilcharts/layerchart-tooltip","@evilcharts/layerchart-legend","@evilcharts/layerchart-brush","@evilcharts/layerchart-background"],
		dependencies: ["layerchart","@humanspeak/svelte-motion"],
	...
	'layerchart-radar-chart': {
		...
		type: 'registry:component',
		registryDependencies: ["@evilcharts/layerchart-chart","@evilcharts/layerchart-tooltip","@evilcharts/layerchart-legend","@evilcharts/layerchart-dot","@evilcharts/layerchart-background"],
		dependencies: ["layerchart","@humanspeak/svelte-motion"],
