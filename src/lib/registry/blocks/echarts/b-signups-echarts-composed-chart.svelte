...
>
	...
	<div class="mt-2 min-h-0 flex-1 overflow-hidden sm:mt-3">
		<EChartsComposedChart {data} {config} xDataKey="date" class="size-full" curveType="step">
			...
			<EChartsComposedChart.Bar dataKey="actual" variant="gradient" radius={2} />
			<EChartsComposedChart.Line dataKey="target" strokeVariant="dashed">
