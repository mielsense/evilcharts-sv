...
>
	<div class="min-h-20 flex-1 overflow-hidden">
		<EvilLineChart {data} {config} xDataKey="month" class="size-full" curveType="monotone">
			<EvilLineChart.Grid />
			<EvilLineChart.YAxis />
			<EvilLineChart.Tooltip variant="frosted-glass" />
			<EvilLineChart.Line dataKey="payouts" strokeVariant="solid" strokeWidth={2} glowing>
				<EvilLineChart.ActiveDot variant="colored-border" />
			</EvilLineChart.Line>
			<EvilLineChart.Line dataKey="pending" strokeVariant="solid" strokeWidth={2} glowing>
				<EvilLineChart.ActiveDot variant="colored-border" />
			</EvilLineChart.Line>
		</EvilLineChart>
	</div>
