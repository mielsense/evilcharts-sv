...
// Constants
export const STROKE_WIDTH = 0.8; // default series stroke — <Area strokeWidth> overrides it
export const LOADING_AREA_DATA_KEY = 'loading';
...
export type StackType = 'default' | 'expanded' | 'stacked';

/**
 * Direction of the custom motion.dev intro reveal. LayerChart's own area animation
...
export type RevealAnimationType = Exclude<AreaAnimationType, 'none'>;
