<script lang="ts">
	import { EChartsBarChart } from '$lib/registry/charts/echarts-bar-chart/index.js';
...
<EChartsBarChart {data} config={chartConfig} class="h-full w-full p-4" xDataKey="month">
