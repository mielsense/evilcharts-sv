<script lang="ts">
	/** BunIcon, ported verbatim from the reference's `src/assets/icons/index.tsx`. */
...
<svg xmlns="http://www.w3.org/2000/svg" {width} {height} viewBox="0 0 32 32" {...rest}>
	<path
		{fill}
	...
	/>
	<ellipse cx="21.65" cy="18.62" {fill} rx="2.17" ry="1.28" />
	<ellipse cx="10.41" cy="18.62" {fill} rx="2.17" ry="1.28" />
	<path
		fill-rule="evenodd"
