<script lang="ts">
	/** ComposedPreview, ported verbatim from the reference's `svg-previews/composed-preview.tsx`. */
</script>
...
>
	...
	<path
		...
		fill-opacity="0.3"
	/>
	<line x1="125" y1="418" x2="769" y2="418" stroke="currentColor" stroke-width="8" opacity="0.3" />
	<path
